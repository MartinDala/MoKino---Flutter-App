...
class ReceitasDoces1 extends StatefulWidget {
  @override
  _ReceitasDoces1State createState() => _ReceitasDoces1State();
}

class _ReceitasDoces1State extends State<ReceitasDoces1> {
  @override
